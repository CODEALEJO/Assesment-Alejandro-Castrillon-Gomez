...
namespace Assesment_Alejandro_Castrillon_Gomez_bernslee.Config;
public class Utilities
{
    ...
    {
        // Validar que el usuario y sus propiedades clave no sean nulas
        ...
        var token = new JwtSecurityToken(
            ...
            claims: claims,
            expires: DateTime.UtcNow.AddMinutes(Convert.ToDouble(jwtExpiresIn ?? "30")), // Valor por defecto
